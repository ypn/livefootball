  ...
  <div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Bảng danh sách các giải đấu</h2>
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              </li>
              <li><a href="/dashboard/leaguage/create"><i class="fa fa-plus"></i></a></li>
                ...
                <table class="table table-striped jambo_table bulk_action">
                  ...
                  <tbody>
                    ...
                    <tr class="even pointer">
                      ...
                      <th class="a-center">
                        <img style="width:30px;height:30px;object-fit:cover;" src="{{$l->logo_url}}" alt="">
                      </th>
